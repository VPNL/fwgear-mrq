...
disp('Promoting outputs to the top-level...');
copyfile(fullfile(subject_output_dir, 'OutPutFiles_1', 'summary.jpg'), fullfile(output_dir, [ subject.code '_' session.label '-summary.jpg' ]), 'f');
...
disp('Generating output archive...');
